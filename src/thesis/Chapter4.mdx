...
import { IframeSwitch } from '../components/IframeSwitch';
...
<figure id="fig:2d_gcs_comparison">
    ...
    <div className="flex flex-row justify-between items-start flex-wrap">
        <figure id="fig:2d_obstacles" className="flex-1 min-w-[100px] max-w-[40%] m-0.5 text-center">
            <img src="figures/two_dimensional_example/environment.png" className="w-full h-auto" />
            <figcaption>(a) 2D Environment</figcaption>
        </figure>
        <figure id="fig:2d_decomposition" className="flex-1 min-w-[100px] max-w-[40%] m-0.5 text-center">
            <img src="figures/two_dimensional_example/decomposition.png" className="w-full h-auto" />
            <figcaption>(b) Free Space</figcaption>
        </figure>
        <figure id="fig:classical_gcs" className="flex-1 min-w-[100px] max-w-[40%] m-0.5 text-center">
            <img src="figures/two_dimensional_example/gcs_classical.gif" className="w-full h-auto" />
            <img src="figures/two_dimensional_example/classical_gcs_deriatives.png" className="w-full h-auto" />
            <figcaption>(c) Convex GCS</figcaption>
        </figure>
        <figure id="fig:gcs_toppra" className="flex-1 min-w-[100px] max-w-[40%] m-0.5 text-center">
            <img src="figures/two_dimensional_example/gcs_toppra.gif" className="w-full h-auto" />
            <img src="figures/two_dimensional_example/toppra_gcs_derivatives.png" className="w-full h-auto" />
            <figcaption>(d) GCS + TOPP</figcaption>
        </figure>
        <figure id="fig:gcs_nonlinear" className="flex-1 min-w-[100px] max-w-[40%] m-0.5 text-center">
            <img src="figures/two_dimensional_example/gcs_nonlinear.gif" className="w-full h-auto" />
            <img src="figures/two_dimensional_example/ngcs_derivatives.png" className="w-full h-auto" />
    ...
    class="math inline">𝒬<sub><em>i</em></sub></span> (in light blue). The
...
allows derivative bounds up to the order of the Bézier curve and higher
...
Bézier curves of order six are used for each region.
...
<figure id="fig:2d_subgraphs">
    <div className="flex flex-row text-center justify-between items-start flex-wrap">
        <figure id="fig:inter_gcs" className="flex-1 min-w-[300px] m-2.5">
            <div className="flex flex-row items-center flex-wrap">
                <Suspense fallback={null}>
                    <img src="figures/two_dimensional_example/gcs_intermediate.gif" className="h-[200px] w-auto object-contain m-1.25" />
                    <img src="figures/two_dimensional_example/intermediate_derivatives.png" className="h-[200px] w-auto object-contain m-1.25" />
                </Suspense>
                <figcaption>(a) Planning through Subspaces</figcaption>
            </div>
        </figure>
        <figure id="fig:multi_gcs" className="flex-1 min-w-[300px] m-2.5">
            <div className="flex flex-row items-center flex-wrap">
                <Suspense fallback={null}>
                    <img src="figures/two_dimensional_example/gcs_multi_start.gif" className="h-[200px] w-auto object-contain m-1.25" />
                    <img src="figures/two_dimensional_example/multi_start_derivatives.png" className="h-[200px] w-auto object-contain m-1.25" />
                </Suspense>
...
<figure id="fig:uav" className="mx-0">
    <UAVOverview />
...
<figure id="fig:kuka_env" className="mx-0">
    <div className="flex flex-row text-center justify-around items-start flex-wrap w-full">
    <figure id="fig:kuka_waypoints" className="flex-1 m-0 min-w-[250px] max-w-[33%]">
        <Suspense fallback={null}>
            <img src="figures/iiwa_example/waypoint_seeds_labelled.jpg" className="w-full h-auto"/>
        </Suspense>
        <figcaption>(a) Waypoints</figcaption>
    </figure>
    <figure id="fig:kuka_extra_seeds" className="flex-1 my-0 mx-1.5 min-w-[250px] max-w-[33%]">
        <Suspense fallback={null}>
            <img src="figures/iiwa_example/additional_seeds_labelled.jpg" className="w-full h-auto"/>
        </Suspense>
        <figcaption>(b) Additional Seeds</figcaption>
    </figure>
    <figure className="flex-1 m-0 min-w-[250px] max-w-[33%]">
        <Suspense fallback={null}>
            <img src="figures/iiwa_example/graph_crop.jpg" className="w-full h-auto"/>
        </Suspense>
    </figure>
    </div>
    <figcaption>Figure 7: The top left image illustrates the planning
    environment with designated waypoints <span
    class="math inline"><em>q</em><sub>1−5</sub></span> and the robot arms
...
<figure id="fig:kuka_traj" className="flex flex-row justify-between items-end flex-wrap mx-0">
    <IframeSwitch src="meshcats/iiwa_ngcs.html" height="600px">
    <Suspense fallback={null}>
        <div className="flex flex-col">
            <img src="figures/iiwa_example/iiwa_gcs_comparison.png" className="w-full h-auto" />
            <img src="figures/iiwa_example/gcs_comparison_derivative.png" className="w-full h-auto" />
        </div>
    </Suspense>
    </IframeSwitch>
...
shapes differ significantly. We utilize fifth-order Bézier curves to
...
<figure id="fig:ik_planning" className="mx-0">
    <IframeSwitch src="meshcats/iiwa_ik.html" height="600px">
        <div className="flex flex-row text-center justify-around items-start flex-wrap">
            <figure id="fig:ik_start" className="m-0 min-w-[250px] max-w-[33%]">
                <Suspense fallback={null}>
                    <img src="figures/iiwa_example/ik_traj_start.png" className="flex-1 m-0" />
                </Suspense>
                <figcaption>(a) The robot starts in the right bin</figcaption>
            </figure>
            <figure id="fig:ik_goal_configuration" className="my-0 mx-0.5 min-w-[250px] max-w-[33%]">
                <Suspense fallback={null}>
                    <img src="figures/iiwa_example/ik_traj_configuration.png" className="flex-1 m-0" />
                </Suspense>
                <figcaption>(b) Planning to a goal configuration</figcaption>
            </figure>
            <figure id="fig:ik_goal_position" className="m-0 min-w-[250px] max-w-[33%]">
                <Suspense fallback={null}>
                    <img src="figures/iiwa_example/ik_traj_position.png" className="flex-1 m-0" />
                </Suspense>
...
right bin to the top of the shelf. We utilize fifth-order Bézier regions
...
<figure id="fig:kuka_min_distance">
    <IframeSwitch src="meshcats/iiwa_dist.html" height="600px">
    <Suspense fallback={null}>
...
<figure id="fig:spot_overview" className="mx-0">
    <IframeSwitch src="meshcats/spot_store.html" height="600px">
        <Suspense fallback={null}>
            <img src="figures/spot/spot_grasp_simple.png" className="w-full h-auto" />
        </Suspense>
    </IframeSwitch>
...
<figure id="fig:spot_graph">
    <Suspense fallback={null}>
        <img src="figures/spot/spot_graph.png" className="w-full h-auto"/>
    </Suspense>
...
contains all the collision-free regions (fifth-order Bézier curve). Zero
...
<figure id="fig:spot_collision_environmen" className="mx-0">
<IframeSwitch src="meshcats/spot_store_clutter.html" height="600px">
    <Suspense fallback={null}>
        <img src="figures/spot/spot_collision_environment.png" className="w-full h-auto"/>
    </Suspense>
</IframeSwitch>
...
<figure id="fig:spot_clutter_failure" className="mx-0" >
    <div className="flex flex-row text-center justify-around items-start flex-wrap">
    <figure id="fig:spot_clutter_failure_body" className="m-0 min-w-[250px] max-w-[33%]">
        <Suspense fallback={null}>
        <img src="figures/spot/spot_singulate_failure.png" className="flex-1 m-0" />
        </Suspense>
        <figcaption>(a) Spot’s body collides with the shelf during the initial
        approach.</figcaption>
    </figure>
    <figure id="fig:spot_clutter_failure_grasp" className="my-0 mx-0.5 min-w-[250px] max-w-[33%]">
        <Suspense fallback={null}>
        <img src="figures/spot/spot_grap_failure.png" className="flex-1 m-0" />
        </Suspense>
        <figcaption>(b) The sugar box being grasped collides with the
        shelf.</figcaption>
    </figure>
    <figure id="fig:spot_clutter_failure_drop" className="m-0 min-w-[250px] max-w-[33%]">
        <Suspense fallback={null}>
        <img src="figures/spot/spot_drop_failure.png" className="flex-1 m-0" />
        </Suspense>
...
<figure id="fig:spot_clutter_collision" className="mx-0"> 
    <div className="flex flex-row text-center justify-between items-start">
        <figure className="ml-0 mr-1.25">
            <Suspense fallback={null}>
                <img src="figures/spot/spot_grap_collision.png" />
            </Suspense>
            <figcaption>The collision sphere ensures sufficient clearance from the shelf while grasping the sugar box.</figcaption>
        </figure>
        <figure className="ml-0 mr-1.25">
            <Suspense fallback={null}>
                <img src="figures/spot/spot_drop_collision.png" />
            </Suspense>
            <figcaption>The sphere helps prevent collisions with the other sugar boxes during the drop-off phase.</figcaption>
        </figure>
    </div>
...
<figure id="fig:spot_clutter_success" className="mx-0">
    <div className="flex flex-row text-center justify-around items-start flex-wrap">
    <figure id="fig:spot_clutter_success_body" className="m-0 min-w-[250px] max-w-[33%]">
        <Suspense fallback={null}>
        <img src="figures/spot/spot_singulate_clutter.png" className="flex-1 m-0" />
        </Suspense>
        <figcaption>(a) Spot avoids the blue shelf by repositioning its body while
        maintaining the desired grasp location.</figcaption>
    </figure>
    <figure id="fig:spot_clutter_success_grasp" className="my-0 mx-0.5 min-w-[250px] max-w-[33%]">
        <Suspense fallback={null}>
        <img src="figures/spot/spot_grap_cluttered.png" className="flex-1 m-0" />
        </Suspense>
        <figcaption>(b) The arm lifts the sugar box over the shelf without
        collision.</figcaption>
    </figure>
    <figure id="fig:spot_clutter_success_drop" className="m-0 min-w-[250px] max-w-[33%]">
        <Suspense fallback={null}>
        <img src="figures/spot/spot_drop_clutter.png" className="flex-1 m-0" />
        </Suspense>
...
<figure id="fig:spot_bimanual">
    <IframeSwitch src="meshcats/spot_bimanual.html" height="600px">
...
reach between each other’s legs (top right), close their grippers, and
...
<figure id="fig:spot_bimanual_highlight">
    ...
    50-dimensional configuration space. The robots reach under each other’s
...
Bézier curves results in five control points per region, resulting in a
