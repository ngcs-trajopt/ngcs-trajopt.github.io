...
<figure id="fig:2d_gcs_comparison">
    <figure id="fig:2d_obstacles">
        <img src="figures/two_dimensional_example/environment.png" />
        <figcaption>2D Environment</figcaption>
    </figure>
    <figure id="fig:2d_decomposition">
        <img src="figures/two_dimensional_example/decomposition.png" />
        <figcaption>Free Space</figcaption>
    </figure>
    <figure id="fig:classical_gcs">
        {/* <p><img src="figures/two_dimensional_example/classical_gcs_traj.png"
        style="width:100.0%" alt="image" /> <img
        src="figures/two_dimensional_example/classical_gcs_deriatives.png"
        style="height:120.0%" alt="image" /></p> */}
        <figcaption>Convex GCS</figcaption>
    </figure>
    <figure id="fig:gcs_toppra">
        {/* <p><img src="figures/two_dimensional_example/toppra_gcs_traj.png"
        style="width:100.0%" alt="image" /> <img
        src="figures/two_dimensional_example/toppra_gcs_derivatives.png"
        style="height:120.0%" alt="image" /></p> */}
        <figcaption>GCS + TOPP</figcaption>
    </figure>
    <figure id="fig:gcs_nonlinear">
        {/* <p><img src="figures/two_dimensional_example/ngcs_traj.png"
        style="width:100.0%" alt="image" /> <img
        src="figures/two_dimensional_example/ngcs_derivatives.png"
        style="height:120.0%" alt="image" /></p> */}
        <figcaption>NGCS</figcaption>
    </figure>
...
<figure id="fig:2d_subgraphs">
    <figure id="fig:inter_gcs">
        <img src="figures/two_dimensional_example/intermediate_traj.png" />
        <img
        src="figures/two_dimensional_example/intermediate_derivatives.png" />
        <figcaption>Planning through Subspaces</figcaption>
    </figure>
    <figure id="fig:multi_gcs">
        <img src="figures/two_dimensional_example/multi_start_traj.png" />
        <img
        src="figures/two_dimensional_example/multi_start_derivatives.png" />
        <figcaption>Multi Start/Goal Planning</figcaption>
    </figure>
...
![Figure 6: Three candidate trajectories for a quadrotor navigating from
...
<figure id="fig:kuka_env">
<figure id="fig:kuka_waypoints">
<embed src="figures/iiwa_example/waypoint_seeds_labelled.pdf" />
<figcaption>Waypoints</figcaption>
</figure>
<figure id="fig:kuka_extra_seeds">
<embed src="figures/iiwa_example/additional_seeds_labelled.pdf" />
<figcaption>Additional Seeds</figcaption>
</figure>
<figure>
<embed src="figures/iiwa_example/graph_crop.pdf" />
</figure>
...
<figure id="fig:kuka_traj">
<div class="center">
{/* <p><img src="figures/iiwa_example/iiwa_gcs_comparison.png"
...
<figure id="fig:ik_planning">
    <figure id="fig:ik_start">
        <img src="figures/iiwa_example/ik_traj_start.png" />
        <figcaption>The robot starts in the right bin</figcaption>
    </figure>
    <figure id="fig:ik_goal_configuration">
        <img src="figures/iiwa_example/ik_traj_configuration.png" />
        <figcaption>Planning to a goal configuration</figcaption>
    </figure>
    <figure id="fig:ik_goal_position">
        <img src="figures/iiwa_example/ik_traj_position.png" />
        <figcaption>Jointly solving for IK</figcaption>
    </figure>
...
![Figure 10: The Kuka arm is avoiding the middle using minimum distance
constraints, since it hasn't been captured by the iris
regions.](figures/iiwa_example/iiwa_min_distance.png)
...
![Figure 11: Simulation environment for Spot's multi-stage manipulation
...
orange.](figures/spot/spot_grasp_simple.png)
...
![Figure 12: Sequential graph of Spot's multi-stage manipulation task.
...
connected.](figures/spot/spot_graph.png)
...
![Figure 13: The simulation environment presents a new challenge with
...
trajectory to avoid
collisions.](figures/spot/spot_collision_environment.png)
...
<figure id="fig:spot_clutter_failure">
    <figure id="fig:spot_clutter_failure_body">
        <img src="figures/spot/spot_singulate_failure.png" />
        <figcaption>Spot’s body collides with the shelf during the initial
        approach.</figcaption>
    </figure>
    <figure id="fig:spot_clutter_failure_grasp">
        <img src="figures/spot/spot_grap_failure.png" />
        <figcaption>The sugar box being grasped collides with the
        shelf.</figcaption>
    </figure>
    <figure id="fig:spot_clutter_failure_drop">
        <img src="figures/spot/spot_drop_failure.png" />
        <figcaption>Another sugar box obstructs the path as Spot moves towards
...
<figure id="fig:spot_clutter_collision">
    <figure>
...
<figure id="fig:spot_clutter_success">
    <figure id="fig:spot_clutter_success_body">
        <img src="figures/spot/spot_singulate_clutter.png" />
        <figcaption>Spot avoids the blue shelf by repositioning its body while
        maintaining the desired grasp location.</figcaption>
    </figure>
    <figure id="fig:spot_clutter_success_grasp">
        <img src="figures/spot/spot_grap_cluttered.png" />
        <figcaption>The arm lifts the sugar box over the shelf without
        collision.</figcaption>
    </figure>
    <figure id="fig:spot_clutter_success_drop">
        <img src="figures/spot/spot_drop_clutter.png" />
        <figcaption>As Spot drops the sugar box into the bin among other
...
<figure>
{/* <p><img src="figures/spot/spot_bimanual_0.png" alt="image" /> <img
src="figures/spot/spot_bimanual_4.png" alt="image" /></p> */}
</figure>
<figure>
{/* <p><img src="figures/spot/spot_bimanual_1.png" alt="image" /> <img
src="figures/spot/spot_bimanual_5.png" alt="image" /></p> */}
</figure>
<figure>
{/* <p><img src="figures/spot/spot_bimanual_2.png" alt="image" /> <img
src="figures/spot/spot_bimanual_6.png" alt="image" /></p> */}
</figure>
<figure>
{/* <p><img src="figures/spot/spot_bimanual_3.png" alt="image" /> <img
src="figures/spot/spot_bimanual_7.png" alt="image" /></p> */}
</figure>
